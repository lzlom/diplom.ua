...
if(!empty($cat)&&!empty($type)){
    ...
    if(!empty($type)){$querycat="AND type_tovara='$type'";
    }else{$querycat="";}
    
     if(!empty($cat)){$catlink="cat=$cat&";
    }else{$catlink="";}
}
    ...
    $count = mysql_query("SELECT COUNT(*) FROM table_products WHERE visible = '1' $querycat $qury_start_num",$link);
