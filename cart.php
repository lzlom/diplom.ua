...
if  (strlen($row["image"]) > 0 && file_exists("./userfiles/".$row["image"]))
{
...
';
 ...
 echo '
 <h2 class="itog-price" align="right">Всего: <strong>'.group_numerals($all_price).'</strong> грн</h2>
...
<li><label for="order_phone"><span>*</span>Телефон</label><input type="text" name="order_phone" id="order_phone" value="'.$_SESSION["order_phone"].'" /><span class="order_span_style" >Пример: +380682356608</span></li>
<li><label class="order_label_style" for="order_address"><span>*</span>Адрес<br /> доставки</label><input type="text" name="order_address" id="order_address" value="'.$_SESSION["order_address"].'" /><span>Пример: г. Чернигов,<br /> ул Шевченко, 99</span></li>
';
}
echo '
