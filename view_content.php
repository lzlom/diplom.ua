...
do
{   
if  (strlen($row1["image"]) > 0 && file_exists("./userfiles/".$row1["image"]))
{
$img_path = './userfiles/'.$row1["image"];
$max_width = 200; 
$max_height = 200; 
...
<p id="nav-breadcrumbs2"><a href="view_cat.php?type=shoes"></a> \ <span>'.$row1["brand"].'</span></p>
<div id="block-like">
...
<a style="display:none;" class="image-modal" rel="group" id="image'.$row["id"].'" ><img  src="./userfiles/'.$row["image"].'" /></a>
';
}
